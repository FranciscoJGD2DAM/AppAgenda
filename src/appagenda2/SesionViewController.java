...
public class SesionViewController implements Initializable {
    ...
    private void onActionButtonGuardar(ActionEvent event) {
        ...
        rootMain.getChildren().remove(rootAgendaView);
        ...
        //Excepcion en el labeltext de numero hijos
        ...
        //Excepcion en el labeltext del Salario
        ...
        persona.setJubilado(checkBoxJubilado.isSelected()); //Se pone aqui? ---------------
